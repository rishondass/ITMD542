...
#### Project Description
This lab we're working on a basic CRUD Node JS Express application. It acts as a contact database where we can create, edit, view, or delete contacts. We use a JSON file to have persistent data throu
